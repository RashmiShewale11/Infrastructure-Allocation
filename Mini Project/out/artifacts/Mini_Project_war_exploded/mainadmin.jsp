...
<div align="center">
    ...
    <div class="card mb-3" style="border: none">
        ...
        <div class="card-header ml-auto" style="background: transparent;background-color: lightgray">
            <b></b>
                <button style="" class=" btn" onclick="toscroll()"><a href="#">Add Assistant  <i
                        class="fa fa-plus-square" aria-hidden="true"></i></a></button>
            <br/>
        </div>
        <br/>
        <div class="card-body">
                ...
                <table id="tab1" class="table table-bordered" width="100%" cellspacing="0">
                    ...
                    <%
                        try {
                            //Connection con = myDB.getCon();
                            if (con != null) {
                                PreparedStatement stmt = con.prepareStatement("select * from assistant inner join Labs detail on assistant.assistant_id = detail.assistant_id");
                                ...
                                while (rs.next()) {
                                    ...
                                    out.print("</td>");
                                    out.print("<td>");
                                    out.print(rs.getString("detail.lab_no"));
                                    out.print("</td>");
                                    out.print("<td>");
...
<br><br>
<div class="container-fluid" id="insert_assistant"
     style="box-shadow: 20px 20px 20px #888888; width:820px; height:auto;">
    <form method="post" action="/jsp/insert_lab_assistant.jsp">
        ...
        <div class="row mt-2">
            <div class="col-md-6">
                <label class="mylabel">Lab_ID</label>
            </div>
            <div class="col-md-6">
                <input type="text" id="lab_id1" name="lab_id1">
            </div>
        </div>
        <div class="row mt-2">
            <div class="col-md-6">
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-6">
                <select name="dept1" class="custom-select" id="dept1" required>
        ...
        <div><%
            if (session.getAttribute("err") != null) {
                out.print("<div><p style= 'color:red;'>Already Assistant ID/Lab Id present</p></div>");
...
<div id="edit1" class="modal ml-auto mr-auto">
    <span onclick="document.getElementById('edit1').style.display='none'" class="close"
    ...
    <form class="modal-content" action="/jsp/edit_assistant.jsp" method="post" style="width: 600px; height:500px;">
        <div class="container " align="center">
            ...
            <input type="text" placeholder="Enter Assistant_id" name="assistant_id1" id="assistant_id1" value=""
                   readonly required>
            <br><br>
            ...
            <div class="clearfix">
                ...
                <button type="button" onclick="document.getElementById('edit1').style.display='none'"
