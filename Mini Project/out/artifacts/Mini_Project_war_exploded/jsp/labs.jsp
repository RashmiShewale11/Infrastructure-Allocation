...
<%
    ...
    try {
        con = myDB.getCon();
        PreparedStatement ps = con.prepareStatement("select * from lab_time inner join Labs detail on lab_time.lab_no = detail.lab_no inner join assistant on detail.assistant_id = assistant.assistant_id  inner join departments di on detail.dept_id = di.dept_id   where id= ?");
                ...
                <div class="col-md-7">
                    <div class="form-group" align="left">
                        ...
                        <input type="text" class="form-control" id="studname" placeholder="Enter Name"
                               name="studname" style="width:250px;" required autocomplete="off"><span style="color: red"
                                                                                   id="errname"></span>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group" align="left">
                        ...
                        <input type="text" class="form-control" id="studmn" placeholder="Enter Mobile Number"
                               name="studmn" style="width:200px;" maxlength="10"><span style="color: red"
                                                                                       id="errmob"></span>
                    </div>
                </div>
                <div class="col-md-2"></div>
...
<script>
    ...
    function validate() {
        var mobile = document.getElementById("studmn").value;
        var name = document.getElementById("studname").value;
        if (mobile == "") {
            document.getElementById("errmob").innerHTML = "Please enter mobile number!";
            return false;
        }
        if (isNaN(mobile)) {
            document.getElementById("errmob").innerHTML = "Only numbers allowed!  ";
            return false;
        }
        if (mobile.length < 10) {
            document.getElementById("errmob").innerHTML = "Enter 10 digit nobile number!";
            return false;
        }
