...
<%
    ...
    try {
        ...
        PreparedStatement stmt1 = con.prepareStatement("select * from seminar_hall_time where  hall_no='A3-002' and from_time not IN ((select from_time from booked_hall where hall_no like '%A3-002%' and book_date = ?))");
...
<form action="/semi_reg.jsp" method="post">
    ...
    <input type="hidden" id="hall_no1" name="hall_no1" value="A3-002">
