...
<%
    ...
    PreparedStatement stmt1 = con.prepareStatement("select * from assistant where assistant_id=?");
    PreparedStatement stmt = con.prepareStatement("select count(*) as event_count from events where flag=0 and assistant_id=?");
                        ...
                        <table id="tab2" class="table table-bordered" width="100%" cellspacing="0">
                            ...
                            <%
                                try {
                                    //Connection con = myDB.getCon();
                                    if (con != null) {
                                        PreparedStatement stmt2 = con.prepareStatement("select * from events where assistant_id=?");
                                        ...
                                        while (rs2.next()) {
                                            if (rs2.getInt("flag") == 0) {
                                                out.print("<tr>");
                                                out.print("<td>");
                                                out.print(rs2.getString("lab_no"));
                                                out.print("</td>");
                                                out.print("<td>");
                            ...
                            <table id="tab3" class="table table-bordered" width="100%" cellspacing="0">
                                ...
                                <%
                                    try {
                                        //Connection con = myDB.getCon();
                                        if (con != null) {
                                            PreparedStatement stmt3 = con.prepareStatement("select * from events where assistant_id=?");
...
<script type="text/javascript">
    ...
    function openEvent2(e) {
        ...
        window.location = "/reject?event_id=" + event_no2 + "&remark=" + remark + " ";
